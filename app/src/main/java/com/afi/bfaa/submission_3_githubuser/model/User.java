package com.afi.bfaa.submission_3_githubuser.model;
...
public class User implements Parcelable {
    ...
    public User(int id, String username, String avatarUrl, String name, String type, String company, String location, int repository, int followers, int following) {
        this.id = id;
        this.login = username;
